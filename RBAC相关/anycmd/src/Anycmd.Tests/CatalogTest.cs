...
namespace Anycmd.Tests
{
    ...
    public class CatalogTest
    {
        ...
        public void CatalogSetShouldRollbackedWhenPersistFailed()
        {
            ...
            acDomain.RemoveService(typeof(IRepository<Catalog, Guid>));
            var moCatalogRepository = acDomain.GetMoqRepository<Catalog, IRepository<Catalog, Guid>>();
            ...
            moCatalogRepository.Setup<Catalog>(a => a.GetByKey(entityId1)).Returns(new Catalog(entityId1) { Name = name });
            moCatalogRepository.Setup<Catalog>(a => a.GetByKey(entityId2)).Returns(new Catalog(entityId2) { Name = name });
            acDomain.AddService(typeof(IRepository<Catalog, Guid>), moCatalogRepository.Object);
