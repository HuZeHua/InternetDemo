    ...
    public class EntityTypeSetTest
    {
        ...
        public void EntityTypeSet()
        {
            ...
            acDomain.Handle(new EntityTypeCreateInput
            {
                ...
                Name = "测试1",
                Codespace = codespace,
                DatabaseId = acDomain.RdbSet.First().Database.Id,
        ...
        public void EntityTypeSetShouldRollbackedWhenPersistFailed()
        {
            ...
            acDomain.RemoveService(typeof(IRepository<EntityType, Guid>));
            var moEntityTypeRepository = acDomain.GetMoqRepository<EntityType, IRepository<EntityType, Guid>>();
            ...
            moEntityTypeRepository.Setup<EntityType>(a => a.GetByKey(entityId1)).Returns(new EntityType(entityId1)
            {
                Name = "test1",
                Code = "EntityType1",
                Codespace = "test",
            ...
            moEntityTypeRepository.Setup<EntityType>(a => a.GetByKey(entityId2)).Returns(new EntityType(entityId2)
            {
                Name = "test2",
                Code = "EntityType2",
                Codespace = "test",
            ...
            acDomain.AddService(typeof(IRepository<EntityType, Guid>), moEntityTypeRepository.Object);
