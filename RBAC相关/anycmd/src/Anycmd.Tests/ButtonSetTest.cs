...
namespace Anycmd.Tests
{
    ...
    public class ButtonSetTest
    {
        ...
        public void ButtonSetShouldRollbackedWhenPersistFailed()
        {
            ...
            var moButtonRepository = acDomain.GetMoqRepository<Button, IRepository<Button, Guid>>();
            var entityId1 = Guid.NewGuid();
            var entityId2 = Guid.NewGuid();
            const string code = "btn1";
            const string name = "测试1";
            acDomain.RemoveService(typeof(IRepository<Button, Guid>));
            ...
            moButtonRepository.Setup<Button>(a => a.GetByKey(entityId1)).Returns(new Button(entityId1) { Code = code, Name = name });
            moButtonRepository.Setup<Button>(a => a.GetByKey(entityId2)).Returns(new Button(entityId2) { Code = code, Name = name });
            acDomain.AddService(typeof(IRepository<Button, Guid>), moButtonRepository.Object);
