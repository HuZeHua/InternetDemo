...
namespace Anycmd.Tests
{
    ...
    public class GroupSetTest
    {
        ...
        public void GroupSetShouldRollbackedWhenPersistFailed()
        {
            ...
            acDomain.RemoveService(typeof(IRepository<Group, Guid>));
            var moGroupRepository = acDomain.GetMoqRepository<Group, IRepository<Group, Guid>>();
            ...
            moGroupRepository.Setup<Group>(a => a.GetByKey(entityId1)).Returns(new Group(entityId1) { Name = name });
            moGroupRepository.Setup<Group>(a => a.GetByKey(entityId2)).Returns(new Group(entityId2) { Name = name });
            acDomain.AddService(typeof(IRepository<Group, Guid>), moGroupRepository.Object);
