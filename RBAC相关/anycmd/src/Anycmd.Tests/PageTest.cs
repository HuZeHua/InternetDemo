...
namespace Anycmd.Tests
{
    ...
    public class PageTest
    {
        ...
        public void PageSetShouldRollbackedWhenPersistFailed()
        {
            ...
            acDomain.RemoveService(typeof(IRepository<UiView, Guid>));
            var moPageRepository = acDomain.GetMoqRepository<UiView, IRepository<UiView, Guid>>();
            ...
            moPageRepository.Setup<UiView>(a => a.GetByKey(entityId1)).Returns(new UiView(entityId1) { });
            moPageRepository.Setup<UiView>(a => a.GetByKey(entityId2)).Returns(new UiView(entityId2) { });
            acDomain.AddService(typeof(IRepository<UiView, Guid>), moPageRepository.Object);
