...
namespace Anycmd.Tests
{
    ...
    public class SysUserTest
    {
        ...
        public void SysUserSet()
        {
            ...
            acDomain.RetrieveRequiredService<IRepository<Account, Guid>>().Add(
            ...
            acDomain.RetrieveRequiredService<IRepository<Account, Guid>>().Context.Commit();
            Assert.IsTrue(acDomain.SysUserSet.GetDevAccounts().Count == 1);
        ...
        public void SysUserSetShouldRollbackedWhenPersistFailed()
        {
            ...
            acDomain.RemoveService(typeof(IRepository<DeveloperId, Guid>));
            var moDeveloperRepository = acDomain.GetMoqRepository<DeveloperId, IRepository<DeveloperId, Guid>>();
            ...
            moDeveloperRepository.Setup<DeveloperId>(a => a.GetByKey(entityId1)).Returns(new DeveloperId(entityId1));
            moDeveloperRepository.Setup<DeveloperId>(a => a.GetByKey(entityId2)).Returns(new DeveloperId(entityId2));
            acDomain.AddService(typeof(IRepository<DeveloperId, Guid>), moDeveloperRepository.Object);
            ...
            acDomain.RetrieveRequiredService<IRepository<Account, Guid>>().Context.Commit();
            Assert.IsNotNull(acDomain.RetrieveRequiredService<IRepository<Account, Guid>>().GetByKey(entityId2));
