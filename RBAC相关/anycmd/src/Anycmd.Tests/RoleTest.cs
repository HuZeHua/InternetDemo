...
namespace Anycmd.Tests
{
    ...
    public class RoleTest
    {
        ...
        public void RoleSetShouldRollbackedWhenPersistFailed()
        {
            ...
            acDomain.RemoveService(typeof(IRepository<Role, Guid>));
            var moRoleRepository = acDomain.GetMoqRepository<Role, IRepository<Role, Guid>>();
            ...
            moRoleRepository.Setup<Role>(a => a.GetByKey(entityId1)).Returns(new Role(entityId1) { Name = name });
            moRoleRepository.Setup<Role>(a => a.GetByKey(entityId2)).Returns(new Role(entityId2) { Name = name });
            acDomain.AddService(typeof(IRepository<Role, Guid>), moRoleRepository.Object);
        ...
        public void TestRoleHierarchy()
        {
            ...
            Assert.IsNotNull(acDomain.RetrieveRequiredService<IRepository<Privilege, Guid>>().AsQueryable().FirstOrDefault(a => a.Id == privilegeId));
