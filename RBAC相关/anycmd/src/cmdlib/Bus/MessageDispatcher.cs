...
namespace Anycmd.Bus
{
    ...
    public class MessageDispatcher : IMessageDispatcher
    {
        ...
        public virtual void DispatchMessage<TMessage>(TMessage message)
        {
            if (message == null)
            {
        ...
        public virtual void Register<TMessage>(IHandler<TMessage> handler)
        {
        ...
        /// <param name="handler">将被注册的消息处理器对象。</param>
        public virtual void UnRegister<TMessage>(IHandler<TMessage> handler)
        {
            var keyType = typeof(TMessage);
            if (_handlers.ContainsKey(keyType) &&
