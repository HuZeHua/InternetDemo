...
namespace Anycmd.Snapshots.Providers
{
    ...
    /// 表示该接口的实现类是快照提供程序。
    /// </summary>
    public interface ISnapshotProvider<TAggregateRootId> : IUnitOfWork, IDisposable
    {
        /// <summary>
        ...
        bool CanCreateOrUpdateSnapshot(ISourcedAggregateRoot<TAggregateRootId> aggregateRoot);
        ...
        void CreateOrUpdateSnapshot(ISourcedAggregateRoot<TAggregateRootId> aggregateRoot);
        ...
        ISnapshot<TAggregateRootId> GetSnapshot(Type aggregateRootType, TAggregateRootId id);
        ...
        bool HasSnapshot(Type aggregateRootType, TAggregateRootId id);
