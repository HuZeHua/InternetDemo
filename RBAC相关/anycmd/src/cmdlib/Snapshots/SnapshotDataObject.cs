...
namespace Anycmd.Snapshots
{
    ...
    [XmlRoot]
    [DataContract]
    public class SnapshotDataObject<TAggregateRootId> : IEntity<TAggregateRootId>
    {
        /// <summary>
        ...
        /// <returns>True if obj is an instance of the <see cref="Anycmd.Snapshots.SnapshotDataObject{T}"/> type and equals the value of this
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj == null)
                return false;
            var other = obj as SnapshotDataObject<TAggregateRootId>;
