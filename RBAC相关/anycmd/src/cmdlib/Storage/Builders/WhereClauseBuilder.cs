...
namespace Anycmd.Storage.Builders
{
        ...
        where TDataObject : class, new()
    {
        ...
        /// <summary>
        /// 读取一个字符串，这个字符串表示where语句中的LIKE操作。
        /// </summary>
        ...
        /// <summary>
        /// 读取一个字符串，这个字符串表示like语句中的“%”（宽字符占位符）。
        /// </summary>
        ...
        /// <summary>
        /// 读取一个字符串，这个字符串表示数据库参数所使用的参数打头字母，比如SQLServer使用“@”而Oracle使用“:”。
        /// </summary>
        ...
        /// <summary>
        /// 访问 <see cref="System.Linq.Expressions.BinaryExpression"/>表达式的子节点。
        /// </summary>
        /// <param name="node">将被访问的二元表达式。</param>
        /// <returns>如果它或者任何它的子节点变更了，返回变更后的表达式；否则，返回原表达式。</returns>
        ...
        /// <summary>
        /// 访问 <see cref="System.Linq.Expressions.MemberExpression"/>的子节点。
        /// </summary>
        /// <param name="node">将被访问的表达式。</param>
        /// <returns>如果它或者它的子表达式变更了，然会变更后的表达式；否则返回原表达式。</returns>
        ...
        /// <summary>
        /// 访问 <see cref="System.Linq.Expressions.ConstantExpression"/>表达式的子节点。
        /// </summary>
        /// <param name="node">将要访问的表达式。</param>
        /// <returns>如果它或者它的任何子节点变更了，返回变更后的表达式；否则返回原表达式。</returns>
