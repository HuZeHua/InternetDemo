...
namespace Anycmd.Events
{
    ...
    /// an aggregate root and handles the domain event when <c>SourcedAggregateRoot.RaiseEvent{T}</c>
    /// is called.
    /// </summary>
    public sealed class InlineDomainEventHandler<TDomainEvent, TSourceId> : IDomainEventHandler<TDomainEvent, TSourceId>
        where TDomainEvent : class, IDomainEvent<TSourceId>
    {
        ...
        public InlineDomainEventHandler(ISourcedAggregateRoot<TSourceId> aggregateRoot, MethodInfo mi)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj == (object)null)
                return false;
            var other = obj as InlineDomainEventHandler<TDomainEvent, TSourceId>;
        ...
        public override int GetHashCode()
        {
            if (this._action != null && this._domainEventType != null)
                return ReflectionHelper.GetHashCode(this._action.GetHashCode(), this._domainEventType.GetHashCode());
