    ...
    public sealed class ArchiveState : StateObject<ArchiveState>, IArchive, IStateObject
    {
        ...
        public string RdbmsType
        {
            ...
            private set
            {
                ...
                {
                    throw new GeneralException("意外的关系数据库类型" + value);
                }
                _rdbmsType = value;
            }
        }
        ...
        public OntologyDescriptor Ontology
        {
            get
            {
                if (_ontology == null)
                {
                    ...
                    {
                        throw new GeneralException("意外的本体Id" + this.OntologyId);
                    }
                }
                return _ontology;
            }
        ...
        public void Archive(int numberId)
        {
            ...
            {
                throw new GeneralException("非法的本体" + this.OntologyId.ToString());
            }
