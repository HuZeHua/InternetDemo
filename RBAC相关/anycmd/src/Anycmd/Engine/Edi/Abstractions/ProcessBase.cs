    ...
    public abstract class ProcessBase : EntityBase, IProcess
    {
        ...
        public string Type
        {
            ...
            set
            {
                ...
                if (_type != null)
                {
                    throw new GeneralException("不能更改进程类型");
                }
                else if (value == null)
                {
                    throw new GeneralException("必须指定进程类型");
                }
                ProcessType processType;
                if (!value.TryParse(out processType))
                {
                    throw new GeneralException("非法的进程类型");
                }
                _type = value;
            }
        }
        ...
        public Guid OntologyId
        {
            ...
            set
            {
                ...
                {
                    throw new GeneralException("不能更改关联本体");
                }
                _ontologyId = value;
            }
        }
