            ...
            if (data.Actions != null)
            {
                ...
                if (orgActions != null)
                {
                    foreach (var orgAction in orgActions)
                    {
                        ...
                        if (action == null)
                        {
                            throw new GeneralException("意外的目录动作标识" + orgAction.ActionId);
                        }
                        ...
                        {
                            throw new GeneralException("意外的目录动作目录标识" + orgAction.CatalogId);
                        }
                        ...
                        if (verb == null)
                        {
                            throw new GeneralException("意外的本体动作标识" + orgAction.ActionId);
                        }
