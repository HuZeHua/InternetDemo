    ...
    public sealed class MessageContext : IStackTrace
    {
        ...
        internal bool IsValid
        {
            get
            {
                ...
                {
                    throw new GeneralException("没有配置命令输入验证器");
                }
                ...
                {
                    throw new GeneralException("没有配置权限验证器");
                }
        ...
        public bool NeedAudit
        {
            get
            {
                if (!this._isAuditDetected)
                {
                    ...
                    {
                        throw new GeneralException("未配置命令审核鉴别器");
                    }
        ...
        internal DbCmd ToDbCommand()
        {
            ...
            {
                throw new GeneralException("当前命令的动作码为空");
            }
            ...
            {
                throw new GeneralException("无效的数据库动作类型" + this.Command.Verb);
            }
