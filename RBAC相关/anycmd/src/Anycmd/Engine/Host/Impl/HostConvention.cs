        ...
        public HostConvention()
        {
            ...
            this.PluginBaseDirectory = (pluginType) =>
            {
                ...
                switch (pluginType)
                {
                    ...
                    default:
                        throw new GeneralException("意外的插件类型");
                };
            };
...
FROM    ( SELECT    [Extent1].[Id] AS [Id] ,
        ...
        public AuditType ImplicitAudit
        {
            ...
            set
            {
                ...
                {
                    throw new GeneralException("审核类型配置错误，取值不能是：Invalid或" + AuditType.ImplicitAudit.ToName());
                }
        ...
        public AllowType ImplicitAllow
        {
            ...
            set
            {
                ...
                {
                    throw new GeneralException("访问控制类型配置错误，取值不能是：Invalid或" + AllowType.ImplicitAllow.ToName());
                }
        ...
        public EntityLogon ImplicitEntityLogon {
            ...
            set
            {
                ...
                {
                    throw new GeneralException("实体登录控制类型配置错误，取值不能是：Invalid或" + EntityLogon.ImplicitLogon.ToName());
                }
