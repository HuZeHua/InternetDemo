...
@"SELECT  a.Id ,
    ...
    WHERE   a.DeletionStateCode = 0";
        ...
        {
            var ssdRoleRepository = _acDomain.RetrieveRequiredService<IRepository<SsdRole, Guid>>();
        ...
        {
            var dsdRoleRepository = _acDomain.RetrieveRequiredService<IRepository<DsdRole, Guid>>();
