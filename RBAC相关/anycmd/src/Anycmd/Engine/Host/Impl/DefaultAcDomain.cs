...
namespace Anycmd.Engine.Host.Impl
{
    ...
    public class DefaultAcDomain : AcDomain, IHandler<MemorySetInitingEvent>, IHandler<MemorySetInitializedEvent>
    {
        ...
        private void Construct()
        {
            ...
            base.RdbSet = Rdb.MemorySets.RdbSet.Create(this);
            base.AppSystemSet = Ac.MemorySets.AppSystemSet.Create(this);
            base.ButtonSet = Ac.MemorySets.ButtonSet.Create(this);
