...
namespace Anycmd.Edi.Web.Mvc.Controllers
{
    ...
    public class InfoDicController : AnycmdController
    {
        ...
        public ActionResult Get(Guid? id)
        {
            ...
            return this.JsonResult(GetRequiredService<IRepository<InfoDic, Guid>>().GetByKey(id.Value));
        }
        ...
        public ActionResult GetPlistInfoDics(GetPlistResult input)
        {
            ...
            {
                throw new GeneralException("意外的实体类型Edi.InfoDic");
            }
        ...
        {
            return this.HandleSeparateGuidString(AcDomain.RemoveInfoDic, AcSession, id, ',');
        }
    }
}
