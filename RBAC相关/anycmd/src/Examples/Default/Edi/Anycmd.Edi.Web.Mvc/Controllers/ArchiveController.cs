...
namespace Anycmd.Edi.Web.Mvc.Controllers
{
    ...
    public class ArchiveController : AnycmdController
    {
        ...
        public ActionResult Get(Guid? id)
        {
            ...
            return this.JsonResult(GetRequiredService<IRepository<Archive, Guid>>().GetByKey(id.Value));
        }
        #endregion
        ...
        public ActionResult GetPlistArchives(GetPlistArchives input)
        {
            ...
            {
                throw new GeneralException("意外的实体类型Edi.Archive");
            }
        ...
        {
            return this.HandleSeparateGuidString(AcDomain.RemoveArchive, AcSession, id, ',');
        }
    }
}
