...
namespace Anycmd.Web.Mvc
{
    ...
    public class CacheFilterAttribute : ActionFilterAttribute
    {
        ...
        {
            var acDomain = filterContext.HttpContext.Application[Constants.ApplicationRuntime.ContainerCacheKey] as IAcDomain;
            Debug.Assert(acDomain != null, "acDomain != null");
